...
// TestZEX_CPMSim_BDOS_PCTrap runs the full zexdoc instruction exerciser --
// documented Z80 opcodes only. This takes 30-60+ minutes to complete: not
// a hang, not a bug, not a sandbox artifact -- it genuinely runs that
// long, exercising every documented opcode across its full input space.
// Not part of any default test invocation for exactly this reason. Run it
// deliberately, locally, when actually verifying opcode correctness after
