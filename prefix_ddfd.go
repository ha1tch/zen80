...
func (z *Z80) handleIXHIXL(opcode uint8) bool {
	...
	if x == 2 && (z_val == 4 || z_val == 5) {
		...
		switch y {
		case 0:
			z.add8(val) // ADD A,IXH/IXL
		case 1:
			z.adc8(val) // ADC A,IXH/IXL
		case 2:
			z.sub8(val) // SUB IXH/IXL
		case 3:
			z.sbc8(val) // SBC A,IXH/IXL
		case 4:
			z.and8(val) // AND IXH/IXL
		case 5:
			z.xor8(val) // XOR IXH/IXL
		case 6:
			z.or8(val) // OR IXH/IXL
		case 7:
			z.cp8(val) // CP IXH/IXL
		}
		return true
	}
...
func (z *Z80) getRegisterForIX(index uint8) *uint8 {
	...
	case 3:
		return &z.E
	case 4:
		return &z.IXH // H becomes IXH
	case 5:
		return &z.IXL // L becomes IXL
	case 7:
		return &z.A
	default:
		return &z.A
...
func (z *Z80) getRegisterForIY(index uint8) *uint8 {
	...
	case 3:
		return &z.E
	case 4:
		return &z.IYH // H becomes IYH
	case 5:
		return &z.IYL // L becomes IYL
	case 7:
		return &z.A
	default:
		return &z.A
