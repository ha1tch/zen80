...
func (z *Z80) executeED() int {
	...
	case 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		...
		0x20, 0x21, 0x22, 0x25, 0x26,
		0x2D, 0x2E, 0x2F,
		0x37,
		0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D, 0x3E, 0x3F:
		return 8 // NOP behavior
		// 0x23,0x24,0x27,0x28,0x29,0x2A,0x2B,0x2C,0x30-0x36 moved to
		// the Z80N case block below (SWAPNIB, MIRROR, TEST, BSLA/BSRA/
		// BSRL/BSRF/BRLC DE,B, MUL D,E, ADD HL/DE/BC,A/$im16)
	...
	case 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87,
		0x88, 0x89, 0x8B, 0x8C, 0x8D, 0x8E, 0x8F,
		0x96, 0x97,
		0x99, 0x9A, 0x9B, 0x9C, 0x9D, 0x9E, 0x9F:
		return 8 // NOP behavior
		// 0x8A,0x90-0x95,0x98 moved to the Z80N case block below
		// (PUSH $im16, OUTINB, NEXTREG x2, PIXELDN, PIXELAD, SETAE, JP (C))
	...
	case 0xA6, 0xA7,
		...
		0xBD, 0xBE, 0xBF:
		return 8 // NOP behavior
		// 0xA4,0xA5,0xAC,0xB4,0xB7,0xBC moved to the Z80N case block
		// below (LDIX, LDWS, LDDX, LDIRX, LDPIRX, LDDRX)
	...
	// Z80N (ZX Spectrum Next) extended instructions. Every one of these
	// byte values is undefined on a real classic Z80 (each was carved
	// out of the NOP buckets directly above, verified to fall through
	// to the same 8-cycle-NOP safety net at the bottom of this
	// function when z.Z80N is false -- see /tmp/verify_nop_preserved
	// for the check run before this block existed at all). Instruction
	// bodies live in z80n.go, not here, so this dispatch table stays
	// the only thing that changes in this already-large file.
	if z.Z80N {
		switch opcode {
		case 0x23:
			return z.z80nSwapnib()
		case 0x24:
			return z.z80nMirror()
		case 0x27:
			return z.z80nTest()
		...
		case 0x33:
			return z.z80nAddBCA()
		case 0x34:
			return z.z80nAddHLnn()
		case 0x35:
			return z.z80nAddDEnn()
		case 0x36:
			return z.z80nAddBCnn()
		case 0x8A:
			return z.z80nPush()
		case 0x90:
			return z.z80nOutinb()
		case 0x91:
			return z.z80nNextregNN()
		case 0x92:
			return z.z80nNextregA()
		case 0x93:
			return z.z80nPixeldn()
		case 0x94:
			return z.z80nPixelad()
		case 0x95:
			return z.z80nSetae()
		case 0x98:
			return z.z80nJpC()
